...
urlpatterns = [
    ...
    path('addressdel/',views.Addressdeleteview.as_view(),name='addressdel'),
    path('addresslist/',views.Addresslistview.as_view(),name='addresslist'),
    path('addressupdate/',views.Addressupdateview.as_view(),name='addressupdate'),
